            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-end t-scale">
                        <button class="btn btn-primary mb-3 shadow-lg">Add User &nbsp;<i class="fas fa-plus"></i></button>
                    </div>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user"></i> &nbsp;Daftar Peminjam </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered mydatatable" style="width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>Made Wahyu Purnama Putra</td>
                                            <td>XI RPL 1</td>
                                            <td>Matematika</td>
                                            <td>001</td>
                                            <td>01-01-2020</td>
                                            <td>
                                                <button class="btn btn-primary "><i class="fas fa-outdent"></i> &nbsp;Kembali</button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>I Gde Made Yudha Adistara</td>
                                            <td>XI RPL 1</td>
                                            <td>Fisika</td>
                                            <td>002</td>
                                            <td>01-01-2020</td>
