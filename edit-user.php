                    ...
                    <div class="card w-75">
                        <div class="card-body">
                            <form>
                                ...
                                <div class="form-group row">
                                    <label for="inputNamalengkap1" class="col-sm-2 col-form-label">Nama Lengkap</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputNamalengkap1" placeholder="Nama lengkap" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputNamalengkap4" class="col-sm-2 col-form-label">Kelas</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputNamalengkap4" placeholder="Kelas" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputNamalengkap2" class="col-sm-2 col-form-label">Jurusan</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputNamalengkap2" placeholder="Jurusan" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputNamalengkap5" class="col-sm-2 col-form-label">Nip / Nis</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputNamalengkap5" placeholder="Nip / Nis" required="">
                                    </div>
                                </div>
