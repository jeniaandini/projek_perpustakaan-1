      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="text-center">
            <h1 class="h3 my-5 text-gray-800">Generate Reports</h1>
          </div>
          ...
          <div class="d-flex justify-content-center">
            <div class="row text-center">
              ...
              <div class="card" style="width: 18rem;">
                  <img src="./img/data buku.jpeg" class="card-img-top" alt="">
                     <div class="card-body">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4">
              <div class="card" style="width: 18rem;">
                  <img src="./img/data peminjaman.jpeg" class="card-img-top" alt="">
                     <div class="card-body">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4">
              <div class="card" style="width: 18rem;">
                  <img src="./img/data-siswa.jpeg" class="card-img-top" alt="">
                     <div class="card-body">
